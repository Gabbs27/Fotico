        ...
        return Button {
            ...
            VStack(spacing: 8) {
                Image(systemName: effect.icon)
                    .font(.title2)
                    .foregroundColor(isActive ? Color.eastPrimary : .gray)
                    .frame(width: 56, height: 56)
                    .background(
                        RoundedRectangle(cornerRadius: 12)
                            .fill(isSelected ? Color.eastPrimary.opacity(0.15) : Color.eastSurface)
                    )
                    .overlay(
                        RoundedRectangle(cornerRadius: 12)
                            .stroke(isSelected ? Color.eastPrimary : Color.clear, lineWidth: 1.5)
                    )
